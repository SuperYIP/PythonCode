#coding=utf-8
'''
1.excel,2.excel-->3.excel,4.excel
'''
import openpyxl
# wb1 = openpyxl.load_workbook(r'C:\Users\伊海迪\Desktop\刘德存.xlsx') # excel文件
wb1 = openpyxl.load_workbook(r'C:\Users\伊海迪\Desktop\刘志涛.xlsx') # excel文件
# wb3 = openpyxl.load_workbook(r'C:\Users\伊海迪\Desktop\刘德存_处理后.xlsx') # excel文件
wb3 = openpyxl.load_workbook(r'C:\Users\伊海迪\Desktop\刘志涛_处理后.xlsx') # excel文件
...
for key,value in dic1.items():
    ...
    if len(value) == 5:
        ...
        sheets3[j].cell(index, 11, value[3] * 35)
    index += 1
wb3.save(r'C:\Users\伊海迪\Desktop\刘志涛_处理后.xlsx') # 修改后要保存